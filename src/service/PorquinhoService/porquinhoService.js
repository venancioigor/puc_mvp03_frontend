class PorquinhoService {
    ...
    cadastrarPorquinho(cpfCliente, obj, sd) {
        return fetch('http://127.0.0.1:5001/api/porquinhos/criarPorquinho', {
            method: 'POST',
            headers: {
    ...
    transferirValorEntrePorquinho(idOrigem, idDestino, cpfCliente, valorOrigem) {
        return fetch('http://127.0.0.1:5001/api/porquinhos/porquinho/transferirValorEntrePorquinho', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    getAllPorquinhos(cpf) {
        return fetch(`http://127.0.0.1:5001/api/porquinhos/getAllPorquinhos?cpf=${cpf}`)
            .then(response => response.json())
            .catch(error => console.error(error));
    }
    getSaldoTotalPorquinhos(cpf) {
        return fetch(`http://127.0.0.1:5001/api/porquinhos/getSaldoTotalPorquinhos?cpf=${cpf}`)
            .then(response => response.json())
            .catch(error => console.error(error));
    }

    deletarPorquinho(cpfCliente, idPorquinho) {
        return fetch(`http://127.0.0.1:5001/api/porquinhos/deletarPorquinho?id_porquinho=${idPorquinho}&cpf=${cpfCliente}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            },
